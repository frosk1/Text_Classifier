...
if __name__ == '__main__':
    korpus = Dicto("korpus", "Text_Korpus_aktuell.txt")
    auto_gut = Dicto("auto_gut", "korpus_ZA_auto_gut.txt")
    auto_schlecht = Dicto("auto_schlecht", "korpus_ZA_auto_schlecht.txt")
    auto_schlecht_halbiert = Dicto("auto_schlecht", "korpus_ZA_auto_schlecht_halbiert.txt")
    ...
    # with open("Text_Korpus_aktuell_marked.txt","w") as output:
